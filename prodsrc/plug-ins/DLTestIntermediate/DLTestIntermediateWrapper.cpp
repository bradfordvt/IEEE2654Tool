...
#define MY_THIS(inst, ret) if(inst == NULL)\
	...
	DLTestIntermediate* my_this = (DLTestIntermediate*)(inst->private_data);\
	if(my_this == NULL)\
	{\
...
#define TEST_MY_THIS()\
	DLTestIntermediate* my_this = (DLTestIntermediate*)(inst->private_data);\
	if(my_this == NULL) {\
		my_this = new DLTestIntermediate();\
		if(my_this == NULL) {\
			inst->error_code = translator_error;\
			inst->status_code = translator_broken;\
			return -1;\
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestIntermediateWrapper::get_debug_instance",
			" int translator_uid ");
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestIntermediateWrapper::my_open",
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestIntermediateWrapper::my_close",
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestIntermediateWrapper::config",
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestIntermediateWrapper::my_select",
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestIntermediateWrapper::deselect",
			" struct debug_instance*, uint32_t ");
	MY_THIS(inst, -1)
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestIntermediateWrapper::is_selected",
			" struct debug_instance*, uint32_t ");
	MY_THIS(inst, -1)
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestIntermediateWrapper::get_error_code",
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestIntermediateWrapper::get_error_string",
			" struct debug_instance*, translator_error_code ");
	MY_THIS(inst, "")
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestIntermediateWrapper::get_status_code",
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestIntermediate::get_status_string",
			" struct command_instance*, translator_status ");
	MY_THIS(inst, "")
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestIntermediateWrapper::handle_request",
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestIntermediateWrapper::handle_response",
			" struct debug_instance*, size_t, uint8_t* ");
	MY_THIS(inst, -1)
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestIntermediateWrapper::handle_update_request",
			" struct debug_instance*, size_t, uint8_t* ");
	MY_THIS(inst, -1)
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestIntermediateWrapper::handle_update_response",
			" struct debug_instance*, size_t, uint8_t* ");
	MY_THIS(inst, -1)
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestIntermediateWrapper::handle_inject_request",
			" struct debug_instance*, size_t, uint8_t* ");
	MY_THIS(inst, -1)
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestIntermediateWrapper::handle_inject_response",
			" struct debug_instance*, size_t, uint8_t* ");
	MY_THIS(inst, -1)
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestIntermediateWrapper::handle_command_request",
			" struct debug_instance*, size_t, uint8_t* ");
	MY_THIS(inst, -1)
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestIntermediateWrapper::apply",
			" struct debug_instance* ");
	MY_THIS(inst, -1)
...
{
	SWDEBUG1( struct debug_instance, NULL, "DLTestIntermediateWrapper::get_debug_library_api");
	return &dla;
}
