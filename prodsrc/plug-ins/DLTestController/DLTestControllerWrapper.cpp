...
#define MY_THIS(inst, ret) if(inst == NULL)\
	...
	DLTestController* my_this = (DLTestController*)(inst->private_data);\
	if(my_this == NULL)\
	{\
...
#define TEST_MY_THIS() DLTestController* my_this = (DLTestController*)(inst->private_data);\
	if(my_this == NULL) {\
		my_this = new DLTestController();\
		if(my_this == NULL) {\
			inst->error_code = translator_error;\
			inst->status_code = translator_broken;\
			return -1;\
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestControllerWrapper::get_debug_instance",
			" int translator_uid ");
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestControllerWrapper::my_open",
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestControllerWrapper::my_close",
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestControllerWrapper::config",
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestControllerWrapper::my_select",
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestControllerWrapper::deselect",
			" struct debug_instance*, uint32_t ");
	MY_THIS(inst, -1)
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestControllerWrapper::is_selected",
			" struct debug_instance*, uint32_t ");
	MY_THIS(inst, false)
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestController::get_error_code",
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestController::get_error_string",
			" struct debug_instance*, translator_error_code ");
	MY_THIS(inst, "")
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestController::get_status_code",
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestController::get_status_string",
			" struct debug_instance*, translator_status ");
	MY_THIS(inst, "")
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestControllerWrapper::handle_request",
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestControllerWrapper::handle_response",
			" struct debug_instance*, size_t, uint8_t* ");
	MY_THIS(inst, -1)
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestControllerWrapper::handle_update_request",
			" struct debug_instance*, size_t, uint8_t* ");
	MY_THIS(inst, -1)
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestControllerWrapper::handle_update_response",
			" struct debug_instance*, size_t, uint8_t* ");
	MY_THIS(inst, -1)
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestControllerWrapper::handle_inject_request",
			" struct debug_instance*, size_t, uint8_t* ");
	MY_THIS(inst, -1)
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestControllerWrapper::handle_inject_response",
			" struct debug_instance*, size_t, uint8_t* ");
	MY_THIS(inst, -1)
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestControllerWrapper::handle_command_request",
			" struct debug_instance*, size_t, uint8_t* ");
	MY_THIS(inst, -1)
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestControllerWrapper::apply",
			" struct debug_instance* ");
	MY_THIS(inst, -1)
...
{
	SWDEBUG1( struct debug_instance, NULL, "DLTestController::get_debug_library_api");
	return &dla;
}
