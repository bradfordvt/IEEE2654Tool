...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestDisplayWrapper::get_transform_instance",
			" int translator_uid ");
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestDisplayWrapper::my_open",
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestDisplayWrapper::my_close",
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestDisplayWrapper::config",
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestDisplayWrapper::my_select",
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestDisplayWrapper::deselect",
			" struct transform_instance*, uint32_t ");
	MY_THIS(inst, -1);
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestDisplayWrapper::is_selected",
			" struct transform_instance*, uint32_t ");
	MY_THIS(inst, false);
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestDisplayWrapper::get_error_code",
			" struct transform_instance* ");
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestDisplayWrapper::get_error_string",
			" struct transform_instance* ");
	MY_THIS(inst, "");
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestDisplayWrapper::get_status_code",
			" struct transform_instance* ");
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestDisplayWrapper::get_status_string",
			" struct transform_instance* ");
	MY_THIS(inst, "");
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestDisplayWrapper::handle_request",
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestDisplayWrapper::handle_response",
			" struct transform_instance*, size_t, uint8_t* ");
	MY_THIS(inst, -1);
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestDisplayWrapper::apply",
			" struct transform_instance* ");
	MY_THIS(inst, -1);
...
{
	SWDEBUG1( struct transform_instance, NULL, "TLTestDisplayWrapper::get_transform_library_api");
	return &tla;
}
