...
#define MY_THIS(inst, ret) if(inst == NULL)\
	...
	TLTestIntermediate* my_this = (TLTestIntermediate*)(inst->private_data);\
	if(my_this == NULL)\
	{\
...
#define TEST_MY_THIS() TLTestIntermediate* my_this = (TLTestIntermediate*)(inst->private_data);\
	if(my_this == NULL) {\
		std::cerr << "my_this is NULL" << std::endl;\
		my_this = new TLTestIntermediate();\
		if(my_this == NULL) {\
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestIntermediateWrapper::get_transform_instance",
			" int translator_uid ");
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestIntermediateWrapper::my_open",
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestIntermediateWrapper::my_close",
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestIntermediateWrapper::config",
...
{
	SWDEBUG2( struct transform_instance, NULL, "CLTestIntermediateWrapper::my_select",
...
{
	SWDEBUG2( struct transform_instance, NULL, "CLTestIntermediateWrapper::deselect",
			" struct transform_instance*, uint32_t ");
	MY_THIS(inst, -1)
...
{
	SWDEBUG2( struct transform_instance, NULL, "CLTestIntermediateWrapper::is_selected",
			" struct transform_instance*, uint32_t ");
	MY_THIS(inst, false)
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestIntermediateWrapper::get_error_code",
			" struct transform_instance* ");
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestIntermediateWrapper::get_error_string",
			" struct transform_instance* ");
	MY_THIS(inst, "")
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestIntermediateWrapper::get_status_code",
			" struct transform_instance* ");
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestIntermediateWrapper::get_status_string",
			" struct transform_instance* ");
	MY_THIS(inst, "")
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestIntermediateWrapper::handle_request",
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestIntermediateWrapper::handle_response",
			" struct transform_instance*, size_t, uint8_t* ");
	MY_THIS(inst, -1)
...
{
	SWDEBUG2( struct transform_instance, NULL, "TLTestIntermediateWrapper::apply",
			" struct transform_instance* ");
	MY_THIS(inst, -1)
...
{
	SWDEBUG1( struct transform_instance, NULL, "TLTestIntermediate::get_transform_library_api");
	return &tla;
}
