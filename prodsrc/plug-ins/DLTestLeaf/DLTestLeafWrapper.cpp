...
#define MY_THIS(inst, ret) if(inst == NULL)\
	...
	DLTestLeaf* my_this = (DLTestLeaf*)(inst->private_data);\
	if(my_this == NULL)\
	{\
...
#define TEST_MY_THIS() DLTestLeaf* my_this = (DLTestLeaf*)(inst->private_data);\
	if(my_this == NULL)\
	{\
		my_this = new DLTestLeaf();\
		if(my_this == NULL)\
		{\
			inst->error_code = translator_error;\
			inst->status_code = translator_broken;\
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestLeafWrapper::get_debug_instance",
			" int translator_uid ");
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestLeafWrapper::my_open",
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestLeafWrapper::my_close",
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestLeafWrapper::config",
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestLeafWrapper::my_select",
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestLeafWrapper::deselect",
			" struct debug_instance*, uint32_t ");
	MY_THIS(inst, -1);
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestLeafWrapper::is_selected",
			" struct debug_instance*, uint32_t ");
	MY_THIS(inst, -1);
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestLeafWrapper::get_error_code",
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestLeafWrapper::get_error_string",
			" struct debug_instance*, translator_error_code ");
	MY_THIS(inst, "");
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestLeafWrapper::get_status_code",
			" struct debug_instance*, translator_error_code ");
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestLeafWrapper::get_status_string",
			" struct debug_instance*, translator_error_code ");
	MY_THIS(inst, "");
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestLeafWrapper::handle_request",
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestLeafWrapper::handle_response",
			" struct debug_instance*, size_t, uint8_t* ");
	MY_THIS(inst, -1);
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestLeafWrapper::handle_update_request",
			" struct debug_instance*, size_t, uint8_t* ");
	MY_THIS(inst, -1);
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestLeafWrapper::handle_update_response",
			" struct debug_instance*, size_t, uint8_t* ");
	MY_THIS(inst, -1);
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestLeafWrapper::handle_inject_request",
			" struct debug_instance*, size_t, uint8_t* ");
	MY_THIS(inst, -1);
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestLeafWrapper::handle_command_request",
			" struct debug_instance*, size_t, uint8_t* ");
	MY_THIS(inst, -1);
...
{
	SWDEBUG2( struct debug_instance, NULL, "DLTestLeafWrapper::apply",
			" struct debug_instance* ");
	MY_THIS(inst, -1);
...
{
	SWDEBUG1( struct debug_instance, NULL, "DLTestLeafWrapper::get_debug_library_api");
	return &dla;
}
