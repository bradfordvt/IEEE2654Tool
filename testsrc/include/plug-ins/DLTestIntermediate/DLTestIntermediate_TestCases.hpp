/*
 *    DLTestIntermediate_TestCases.hpp
 *
 *    Class to implement the DLTestIntermediate test cases.
 *
 *    Class to implement the DLTestIntermediate test cases.
 * 
...
#ifndef INCLUDE_PLUGINS_DLTESTINTERMEDIATE_DLTESTINTERMEDIATE_TESTCASES_HPP_
#define INCLUDE_PLUGINS_DLTESTINTERMEDIATE_DLTESTINTERMEDIATE_TESTCASES_HPP_

#include <cppunit/TestFixture.h>
#include <cppunit/extensions/HelperMacros.h>

class DLTestIntermediate_TestCases : public CPPUNIT_NS::TestFixture {
        CPPUNIT_TEST_SUITE( DLTestIntermediate_TestCases );
        CPPUNIT_TEST( DLTestIntermediate_001 );
        CPPUNIT_TEST( DLTestIntermediate_002 );
        CPPUNIT_TEST( DLTestIntermediate_003 );
...
public:
	DLTestIntermediate_TestCases();
	DLTestIntermediate_TestCases( const DLTestIntermediate_TestCases& tc );
	DLTestIntermediate_TestCases& operator=( const DLTestIntermediate_TestCases& tc );
	~DLTestIntermediate_TestCases();

	void DLTestIntermediate_001( );
	void DLTestIntermediate_002( );
	void DLTestIntermediate_003( );
	void open_001( );
	void close_001( );
	void config_001( );
	void select_001( );
...
#endif /* INCLUDE_PLUGINS_DLTESTINTERMEDIATE_DLTESTINTERMEDIATE_TESTCASES_HPP_ */
