/*
 *    DLTestController_TestCases.hpp
 *
 *    Class to implement the DLTestController test cases.
 *
 *    Class to implement the DLTestController test cases.
 * 
...
#ifndef INCLUDE_PLUGINS_DLTESTCONTROLLER_DLTESTCONTROLLER_TESTCASES_HPP_
#define INCLUDE_PLUGINS_DLTESTCONTROLLER_DLTESTCONTROLLER_TESTCASES_HPP_


#include <cppunit/TestFixture.h>
#include <cppunit/extensions/HelperMacros.h>

class DLTestController_TestCases : public CPPUNIT_NS::TestFixture {
        CPPUNIT_TEST_SUITE( DLTestController_TestCases );
        CPPUNIT_TEST( DLTestController_001 );
        CPPUNIT_TEST( DLTestController_002 );
        CPPUNIT_TEST( DLTestController_003 );
...
public:
	DLTestController_TestCases();
	DLTestController_TestCases( const DLTestController_TestCases& tc );
	DLTestController_TestCases& operator=( const DLTestController_TestCases& tc );
	~DLTestController_TestCases();

	void DLTestController_001( );
	void DLTestController_002( );
	void DLTestController_003( );
	void open_001( );
	void close_001( );
	void config_001( );
	void select_001( );
...
#endif /* INCLUDE_PLUGINS_DLTESTCONTROLLER_DLTESTCONTROLLER_TESTCASES_HPP_ */
