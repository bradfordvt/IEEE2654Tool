/*
 *    ILTestLeaf_TestCases.hpp
 *
 *    Class to implement the ILTestLeaf test cases.
 *
 *    Class to implement the ILTestLeaf test cases.
 * 
...
#ifndef INCLUDE_PLUGINS_ILTESTLEAF_ILTESTLEAF_TESTCASES_HPP_
#define INCLUDE_PLUGINS_ILTESTLEAF_ILTESTLEAF_TESTCASES_HPP_

#include <cppunit/TestFixture.h>
#include <cppunit/extensions/HelperMacros.h>

class ILTestLeaf_TestCases : public CPPUNIT_NS::TestFixture {
        CPPUNIT_TEST_SUITE( ILTestLeaf_TestCases );
        CPPUNIT_TEST( ILTestLeaf_001 );
        CPPUNIT_TEST( ILTestLeaf_002 );
        CPPUNIT_TEST( ILTestLeaf_003 );
...
public:
	ILTestLeaf_TestCases();
	ILTestLeaf_TestCases( const ILTestLeaf_TestCases& tc );
	ILTestLeaf_TestCases& operator=( const ILTestLeaf_TestCases& tc );
	~ILTestLeaf_TestCases();
...
#endif /* INCLUDE_PLUGINS_ILTESTLEAF_ILTESTLEAF_TESTCASES_HPP_ */
