/*
 *    CLTestLeaf_TestCases.hpp
 *
 *    Class to implement the CLTestLeaf test cases.
 *
 *    Class to implement the CLTestLeaf test cases.
 * 
...
#ifndef INCLUDE_PLUGINS_CLTESTLEAF_CLTESTLEAF_TESTCASES_HPP_
#define INCLUDE_PLUGINS_CLTESTLEAF_CLTESTLEAF_TESTCASES_HPP_


#include <cppunit/TestFixture.h>
#include <cppunit/extensions/HelperMacros.h>

class CLTestLeaf_TestCases : public CPPUNIT_NS::TestFixture {
        CPPUNIT_TEST_SUITE( CLTestLeaf_TestCases );
        CPPUNIT_TEST( CLTestLeaf_001 );
        CPPUNIT_TEST( CLTestLeaf_002 );
        CPPUNIT_TEST( CLTestLeaf_003 );
...
public:
	CLTestLeaf_TestCases();
	CLTestLeaf_TestCases( const CLTestLeaf_TestCases& tc );
	CLTestLeaf_TestCases& operator=( const CLTestLeaf_TestCases& tc );
	~CLTestLeaf_TestCases();
...
#endif /* INCLUDE_PLUGINS_CLTESTLEAF_CLTESTLEAF_TESTCASES_HPP_ */
