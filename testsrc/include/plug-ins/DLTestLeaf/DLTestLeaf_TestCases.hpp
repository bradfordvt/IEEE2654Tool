/*
 *    DLTestLeaf_TestCases.hpp
 *
 *    Class to implement the DLTestLeaf test cases.
 *
 *    Class to implement the DLTestLeaf test cases.
 * 
...
#ifndef INCLUDE_PLUGINS_DLTESTLEAF_DLTESTLEAF_TESTCASES_HPP_
#define INCLUDE_PLUGINS_DLTESTLEAF_DLTESTLEAF_TESTCASES_HPP_

#include <cppunit/TestFixture.h>
#include <cppunit/extensions/HelperMacros.h>

class DLTestLeaf_TestCases : public CPPUNIT_NS::TestFixture {
        CPPUNIT_TEST_SUITE( DLTestLeaf_TestCases );
        CPPUNIT_TEST( DLTestLeaf_001 );
        CPPUNIT_TEST( DLTestLeaf_002 );
        CPPUNIT_TEST( DLTestLeaf_003 );
...
public:
	DLTestLeaf_TestCases();
	DLTestLeaf_TestCases( const DLTestLeaf_TestCases& tc );
	DLTestLeaf_TestCases& operator=( const DLTestLeaf_TestCases& tc );
	~DLTestLeaf_TestCases();
...
#endif /* INCLUDE_PLUGINS_DLTESTLEAF_DLTESTLEAF_TESTCASES_HPP_ */
